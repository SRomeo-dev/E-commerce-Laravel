        ...
        <section class="section profile">
            <div class="container mt-5">
                <div class="container mt-5">
                    ...
                    <form action="{{ route('client-ajouter') }}" method="POST" class=" p-4 shadow" style="width: 50%;">
                        @csrf
                        <div class="mb-3">
                        ...
                        <div class="mb-3">
                            <label for="password_confirmation" class="form-label" >Cnnfirmer mot depasse</label>
