            ...
            <div class="container mt-5">
                <div class="container mt-5">
                    ...
                    <form class=" p-4 shadow" style="width: 50%;">
                        <div class="mb-3">
                            <label for="name" class="form-label">E-mail actuel</label>
                            <input type="email" name="name" class="form-control" id="name" required>
                            <div class="invalid-feedback">Veuillez entrer votre nouveau mail svp!</div>
                        </div>
                        ...
                        <div class="mb-3">
                            <label for="lastname" class="form-label">Nouveau Prénom</label>
                            <input type="text" name="name" class="form-control" id="yourName" required>
                            <div class="invalid-feedback">Veuillez entrer votre prénom svp!</div>
                        </div>

                        <div class="mb-3">
                            <label for="email" class="form-label">Nouveau E-mail</label>
                        ...
                        <div class="mb-3">
                            <label for="password_confirmation" class="form-label">Cnnfirmer nouveau mot de
                                passe</label>
