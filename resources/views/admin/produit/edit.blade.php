    ...
    <main id="main" class="main">
        ...
        <section class="section profile">
            <div class="container mt-5">
                ...
                <form action="{{ route('produit.update', ['id' => $produit->id]) }}" method="POST" enctype="multipart/form-data" class=" p-4 shadow" style="width: 50%;">
                    @csrf
                    @method('PUT')
                    ...
                    <div class="mb-3">
                        ...
                        <input type="file" class="form-control shadow" id="image" name="image" value="{{ $produit->image }}">
                    </div>

                    <!-- Champs pour le nom, le prix et la description -->
                    <div class="mb-3">
                        <label for="nom" class="form-label">Nom du Produit</label>
                        <input type="text" class="form-control shadow" id="nom" name="nom" value="{{ $produit->nom }}">
                    </div>

                    <div class="mb-3">
                        <label for="prix" class="form-label">Prix</label>
                        <input type="decimale" class="form-control shadow" id="prix" name="prix" value="{{ $produit->prix }}">
                    </div>

                    <div class="mb-3">
                        <label for="description" class="form-label">Description</label>
                        <textarea class="form-control shadow" id="description" rows="3" name="description">{{ $produit->description }}</textarea>
                    </div>
